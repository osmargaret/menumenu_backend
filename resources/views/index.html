        ...
        <div class="row">
          <div class="col-lg-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand iom" href="index.html">
                <img src="wslogo.jpeg" alt="" />
              </a>
              ...
              <div class="navbar-collapse">
                <ul id="nav" class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item">
                    <a class=" " href="communities.html">Communities</a>
                  </li>
                  <li class="nav-item">
                    <a class=" " href="affiliate.html">Affiliate</a>
                  ...
                  <li class="nav-item nav-item-has-children">
                    ...
                    <ul class="ud-submenu">
                      <li class="ud-submenu-item">
                        <a href="Human_Resource_Management.html" class="ud-submenu-link">
                          Human Resource Management
                        </a>
                      </li>
                      <li class="ud-submenu-item">
                        <a href="payroll.html" class="ud-submenu-link">
                          Payroll
                        </a>
                      </li>
                      <li class="ud-submenu-item">
                        <a href="accounting.html" class="ud-submenu-link">
                          Accounting
                        </a>
                      </li>
                      <li class="ud-submenu-item">
                        <a href="commerce.html" class="ud-submenu-link">
                        Commerce
                        </a>
                      </li>
                      <li class="ud-submenu-item">
                      ...
                      <li class="ud-submenu-item">
                        <a href="inventory.html" class="ud-submenu-link">
                         Inventory
                        </a>
                      </li>
                      <li class="ud-submenu-item">
                        <a href="CRM.html" class="ud-submenu-link">CRM</a>

                        <li class="ud-submenu-item">
                        <a href="Project_Management.html" class="ud-submenu-link">Project_Management</a>
                        
                        <li class="ud-submenu-item">
                        <a href="Workflow_Automation.html" class="ud-submenu-link">Workflow_Automation</a>
                        <li class="ud-submenu-item">
                        <a href="Reporting_Analytics.html" class="ud-submenu-link">Reporting_Analytics</a>
                       <li class="ud-submenu-item">
                        <a href="Collaboration_Hub.html" class="ud-submenu-link">Collaboration_Hub</a>
                        <li class="ud-submenu-item">
                        <a href="Signup_Page.html" class="ud-submenu-link">Signup_Page</a>
                      </li>
                    </ul>
                  </li>
                </ul>
          ...
          <div class="col-lg-12">
            <div class="ud-hero-content wow fadeInUp" data-wow-delay=".2s">
              ...
              <p class="ud-hero-desc">
                Wonesuite is an all-in-one business management platform designed to help organizations run their operations, people, finances, and projects from one place—without juggling multiple apps.

Think of it as a smart ERP + HR + finance + workflow system, built especially for growing African businesses and professional firms.
              </p>
              <ul class="ud-hero-buttons">
                ...
                <li>
                  <a href="https://github.com/uideck/play-bootstrap" rel="nofollow noopener" target="_blank" class="ud-main-btn ud-link-btn">
                    Preview Demo <i class="lni lni-arrow-right"></i>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
              <img src="removebghero.png" alt="hero-image" />
              <img
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="ud-section-title">
              <span>Features</span>
              <h2>Core Features of Wonesuite</h2>
              <p>
                <h6>Human Resource Management</h6>

                        Employee profiles & org chart <br>  

                        Recruitment & onboarding workflows<br>  

                        Attendance & leave tracking<br>  

                        Payroll automation<br>

                        Performance reviews & appraisals<br>  
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="ud-section-title mx-auto text-center">
              ...
              <h2>What Wonesuite Users Are Saying</h2>
              <p>
                Hear directly from businesses using Wonesuite 
                to simplify their operations, improve team productivity, 
                and gain better visibility across their work. These real stories reflect how growing companies trust Wonesuite to run their people, projects, 
                and finances in one powerful platform.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-content">
                <p>
                  “Wonesuite completely changed how we manage our operations. 
                  Instead of juggling multiple tools, everything we need is now 
                  in one place.”
                </p>
              </div>
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="https://plus.unsplash.com/premium_photo-1669879825881-6d4e4bde67d5?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.
                    0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cmFuZG9tJTIwcGVvcGxlfGVufDB8fDB8fHww"
                    alt="author"
                  />
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-content">
                <p>
                  “What we love most about Wonesuite is
                   the visibility it gives us. We can track work, people,
                   and finances without confusion.”
                </p>
              </div>
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="ud-widget">
                <a href="index.html" class="ud-footer-logo">
                  <img src="wlogormbg.png" alt="logo" />
                </a>
